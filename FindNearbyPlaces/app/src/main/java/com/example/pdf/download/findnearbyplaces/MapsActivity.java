        ...
        LocationListener
{
    ...
    public void onClick (View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.schools_nearby:
                mMap.clear();
                String url1=getUrl(latitide,longitude,school);
                transferData[0]=mMap;
                transferData[1]=url1;
                getNearbyPlaces.execute(transferData);
            ...
            case R.id.restaurants_nearby:
                mMap.clear();
                String url2=getUrl(latitide,longitude,restaurants);
                transferData[0]=mMap;
                transferData[1]=url2;
                getNearbyPlaces.execute(transferData);
    ...
    private String getUrl(double latitide,double longitude,String nearbyPlace)
    {
        ...
        googleURL.append("&key"+"AIzaSyAEeYfPi5cDvEuFFM7I0UzIP_vHGNwXEWA");
        Log.d("SearchNearbyPlaces","url = "+googleURL.toString());
